    ...
    namespace Algorhytms.GumRuntimes
    {
        public partial class CircleRuntime : Gum.Wireframe.GraphicalUiElement
        {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Algorhytms.GumRuntimes.CircleRuntime.VariableState fromState,Algorhytms.GumRuntimes.CircleRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public int Alpha
            {
                ...
                set
                {
                    var color = ContainedCircle.Color;
                    color.A = (byte)value;
