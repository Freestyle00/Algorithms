    ...
    namespace Algorhytms.GumRuntimes
    {
        public partial class RectangleRuntime : Gum.Wireframe.GraphicalUiElement
        {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Algorhytms.GumRuntimes.RectangleRuntime.VariableState fromState,Algorhytms.GumRuntimes.RectangleRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public int Alpha
            {
                ...
                set
                {
                    var color = ContainedRectangle.Color;
                    color.A = (byte)value;
            ...
            public Microsoft.Xna.Framework.Color Color
            {
                get
                {
                    return ContainedRectangle.Color;
                }
                set
                {
                    ContainedRectangle.Color = value;
                }
            }
