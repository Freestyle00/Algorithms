    ...
    namespace Algorhytms.GumRuntimes
    {
        public partial class NineSliceRuntime : Gum.Wireframe.GraphicalUiElement
        {
                ...
                set
                {
                    ...
                    switch(mCurrentVariableState)
                    {
                        case  VariableState.Default:
                            ...
                            Red = 255;
                            SetProperty("SourceFile", "Standards\\StandardGraphics\\Red_Center.png");
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Algorhytms.GumRuntimes.NineSliceRuntime.VariableState fromState,Algorhytms.GumRuntimes.NineSliceRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
