    ...
    {
        public partial class ComboBoxRuntime : Algorhytms.GumRuntimes.ContainerRuntime
        {
            #region State Enums
                ...
                set
                {
                    ...
                    switch(mCurrentVariableState)
                    {
                        case  VariableState.Default:
                            ...
                            NineSliceInstance.CurrentColorCategoryState = Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Blue;
                    ...
                    if (value != null)
                    {
                        ...
                        switch(mCurrentComboBoxCategoryState)
                        {
                            ...
                            case  ComboBoxCategory.Disabled:
                                NineSliceInstance.CurrentColorCategoryState = Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
                                TextInstance.CurrentColorCategoryState = Algorhytms.GumRuntimes.TextRuntime.ColorCategory.Gray;
                                NineSliceInstance.Blue = 255;
                                NineSliceInstance.Green = 255;
                                NineSliceInstance.Red = 255;
                            ...
                            case  ComboBoxCategory.Highlighted:
                                NineSliceInstance.CurrentColorCategoryState = Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Yellow;
            ...
            public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
            {
                ...
                Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory NineSliceInstanceCurrentColorCategoryStateFirstValue= Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory NineSliceInstanceCurrentColorCategoryStateSecondValue= Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                ...
                switch(firstState)
                {
                    case  VariableState.Default:
                        ...
                        NineSliceInstanceCurrentColorCategoryStateFirstValue = Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Blue;
                ...
                switch(secondState)
                {
                    case  VariableState.Default:
                        ...
                        NineSliceInstanceCurrentColorCategoryStateSecondValue = Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Blue;
            ...
            public void InterpolateBetween (ComboBoxCategory firstState, ComboBoxCategory secondState, float interpolationValue) 
            {
                ...
                switch(firstState)
                {
                    ...
                    case  ComboBoxCategory.Disabled:
                        ...
                        NineSliceInstanceBlueFirstValue = 255;
                        setNineSliceInstanceCurrentColorCategoryStateFirstValue = true;
                        NineSliceInstanceCurrentColorCategoryStateFirstValue = Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
                        setNineSliceInstanceGreenFirstValue = true;
                        NineSliceInstanceGreenFirstValue = 255;
                        setNineSliceInstanceRedFirstValue = true;
                        NineSliceInstanceRedFirstValue = 255;
                    ...
                    case  ComboBoxCategory.Highlighted:
                        ...
                        NineSliceInstanceBlueFirstValue = 255;
                        setNineSliceInstanceCurrentColorCategoryStateFirstValue = true;
                        NineSliceInstanceCurrentColorCategoryStateFirstValue = Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Yellow;
                        setNineSliceInstanceGreenFirstValue = true;
                        NineSliceInstanceGreenFirstValue = 255;
                        setNineSliceInstanceRedFirstValue = true;
                        NineSliceInstanceRedFirstValue = 255;
                ...
                switch(secondState)
                {
                    ...
                    case  ComboBoxCategory.Disabled:
                        ...
                        NineSliceInstanceBlueSecondValue = 255;
                        setNineSliceInstanceCurrentColorCategoryStateSecondValue = true;
                        NineSliceInstanceCurrentColorCategoryStateSecondValue = Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
                        setNineSliceInstanceGreenSecondValue = true;
                        NineSliceInstanceGreenSecondValue = 255;
                        setNineSliceInstanceRedSecondValue = true;
                        NineSliceInstanceRedSecondValue = 255;
                    ...
                    case  ComboBoxCategory.Highlighted:
                        ...
                        NineSliceInstanceBlueSecondValue = 255;
                        setNineSliceInstanceCurrentColorCategoryStateSecondValue = true;
                        NineSliceInstanceCurrentColorCategoryStateSecondValue = Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Yellow;
                        setNineSliceInstanceGreenSecondValue = true;
                        NineSliceInstanceGreenSecondValue = 255;
                        setNineSliceInstanceRedSecondValue = true;
                        NineSliceInstanceRedSecondValue = 255;
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Algorhytms.GumRuntimes.DefaultForms.ComboBoxRuntime.VariableState fromState,Algorhytms.GumRuntimes.DefaultForms.ComboBoxRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Algorhytms.GumRuntimes.DefaultForms.ComboBoxRuntime.ComboBoxCategory fromState,Algorhytms.GumRuntimes.DefaultForms.ComboBoxRuntime.ComboBoxCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            public Algorhytms.GumRuntimes.DefaultForms.ListBoxRuntime ListBoxInstance { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime NineSliceInstance { get; set; }
            public Algorhytms.GumRuntimes.TextRuntime TextInstance { get; set; }
            public Algorhytms.GumRuntimes.SpriteRuntime SpriteInstance { get; set; }
            ...
            {
                ListBoxInstance = this.GetGraphicalUiElementByName("ListBoxInstance") as Algorhytms.GumRuntimes.DefaultForms.ListBoxRuntime;
                NineSliceInstance = this.GetGraphicalUiElementByName("NineSliceInstance") as Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime;
                TextInstance = this.GetGraphicalUiElementByName("TextInstance") as Algorhytms.GumRuntimes.TextRuntime;
                SpriteInstance = this.GetGraphicalUiElementByName("SpriteInstance") as Algorhytms.GumRuntimes.SpriteRuntime;
