    ...
    {
        public partial class UserControlRuntime : Algorhytms.GumRuntimes.ContainerRuntime
        {
            #region State Enums
                ...
                set
                {
                    ...
                    switch(mCurrentVariableState)
                    {
                        case  VariableState.Default:
                            ColoredFrameInstance.CurrentColorCategoryState = Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.TransparentBlack;
                            Height = 300f;
                            Width = 300f;
            ...
            public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
            {
                ...
                switch(firstState)
                {
                    case  VariableState.Default:
                        ...
                        ColoredFrameInstanceCurrentColorCategoryStateFirstValue = Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.TransparentBlack;
                ...
                switch(secondState)
                {
                    case  VariableState.Default:
                        ...
                        ColoredFrameInstanceCurrentColorCategoryStateSecondValue = Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.TransparentBlack;
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Algorhytms.GumRuntimes.DefaultForms.UserControlRuntime.VariableState fromState,Algorhytms.GumRuntimes.DefaultForms.UserControlRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
