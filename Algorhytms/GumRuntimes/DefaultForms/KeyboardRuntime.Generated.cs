    using System.Linq;
    namespace Algorhytms.GumRuntimes.DefaultForms
    {
        public partial class KeyboardRuntime : Algorhytms.GumRuntimes.ContainerRuntime
        {
            #region State Enums
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Algorhytms.GumRuntimes.DefaultForms.KeyboardRuntime.VariableState fromState,Algorhytms.GumRuntimes.DefaultForms.KeyboardRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Algorhytms.GumRuntimes.DefaultForms.KeyboardRuntime.CursorMoveCategory fromState,Algorhytms.GumRuntimes.DefaultForms.KeyboardRuntime.CursorMoveCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            public Algorhytms.GumRuntimes.ContainerRuntime Row1Keys { get; set; }
            public Algorhytms.GumRuntimes.ContainerRuntime KeyRows { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime Key1 { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyQ { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyA { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyZ { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyParenLeft { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyW { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyS { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyX { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyParenRight { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyE { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyD { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyC { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeySpace { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyR { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyF { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyV { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyT { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyG { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyB { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyY { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyH { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyN { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyU { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyJ { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyM { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyI { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyK { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyComma { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyQuestion { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyO { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyL { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyPeriod { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyBang { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyP { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyUnderscore { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyHyphen { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyAmpersand { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime Key2 { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime Key3 { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime Key4 { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime Key5 { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime Key6 { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime Key7 { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime Key8 { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime Key9 { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime Key0 { get; set; }
            public Algorhytms.GumRuntimes.ContainerRuntime Row2Keys { get; set; }
            public Algorhytms.GumRuntimes.ContainerRuntime Row3Keys { get; set; }
            public Algorhytms.GumRuntimes.ContainerRuntime Row4Keys { get; set; }
            public Algorhytms.GumRuntimes.ContainerRuntime Row5Keys { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.ButtonRuntime KeyBackspace { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.ButtonRuntime KeyReturn { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyLeft { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyRight { get; set; }
            ...
            {
                Row1Keys = this.GetGraphicalUiElementByName("Row1Keys") as Algorhytms.GumRuntimes.ContainerRuntime;
                KeyRows = this.GetGraphicalUiElementByName("KeyRows") as Algorhytms.GumRuntimes.ContainerRuntime;
                Key1 = this.GetGraphicalUiElementByName("Key1") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyQ = this.GetGraphicalUiElementByName("KeyQ") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyA = this.GetGraphicalUiElementByName("KeyA") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyZ = this.GetGraphicalUiElementByName("KeyZ") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyParenLeft = this.GetGraphicalUiElementByName("KeyParenLeft") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyW = this.GetGraphicalUiElementByName("KeyW") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyS = this.GetGraphicalUiElementByName("KeyS") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyX = this.GetGraphicalUiElementByName("KeyX") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyParenRight = this.GetGraphicalUiElementByName("KeyParenRight") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyE = this.GetGraphicalUiElementByName("KeyE") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyD = this.GetGraphicalUiElementByName("KeyD") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyC = this.GetGraphicalUiElementByName("KeyC") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeySpace = this.GetGraphicalUiElementByName("KeySpace") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyR = this.GetGraphicalUiElementByName("KeyR") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyF = this.GetGraphicalUiElementByName("KeyF") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyV = this.GetGraphicalUiElementByName("KeyV") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyT = this.GetGraphicalUiElementByName("KeyT") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyG = this.GetGraphicalUiElementByName("KeyG") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyB = this.GetGraphicalUiElementByName("KeyB") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyY = this.GetGraphicalUiElementByName("KeyY") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyH = this.GetGraphicalUiElementByName("KeyH") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyN = this.GetGraphicalUiElementByName("KeyN") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyU = this.GetGraphicalUiElementByName("KeyU") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyJ = this.GetGraphicalUiElementByName("KeyJ") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyM = this.GetGraphicalUiElementByName("KeyM") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyI = this.GetGraphicalUiElementByName("KeyI") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyK = this.GetGraphicalUiElementByName("KeyK") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyComma = this.GetGraphicalUiElementByName("KeyComma") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyQuestion = this.GetGraphicalUiElementByName("KeyQuestion") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyO = this.GetGraphicalUiElementByName("KeyO") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyL = this.GetGraphicalUiElementByName("KeyL") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyPeriod = this.GetGraphicalUiElementByName("KeyPeriod") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyBang = this.GetGraphicalUiElementByName("KeyBang") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyP = this.GetGraphicalUiElementByName("KeyP") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyUnderscore = this.GetGraphicalUiElementByName("KeyUnderscore") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyHyphen = this.GetGraphicalUiElementByName("KeyHyphen") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyAmpersand = this.GetGraphicalUiElementByName("KeyAmpersand") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                Key2 = this.GetGraphicalUiElementByName("Key2") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                Key3 = this.GetGraphicalUiElementByName("Key3") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                Key4 = this.GetGraphicalUiElementByName("Key4") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                Key5 = this.GetGraphicalUiElementByName("Key5") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                Key6 = this.GetGraphicalUiElementByName("Key6") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                Key7 = this.GetGraphicalUiElementByName("Key7") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                Key8 = this.GetGraphicalUiElementByName("Key8") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                Key9 = this.GetGraphicalUiElementByName("Key9") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                Key0 = this.GetGraphicalUiElementByName("Key0") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                Row2Keys = this.GetGraphicalUiElementByName("Row2Keys") as Algorhytms.GumRuntimes.ContainerRuntime;
                Row3Keys = this.GetGraphicalUiElementByName("Row3Keys") as Algorhytms.GumRuntimes.ContainerRuntime;
                Row4Keys = this.GetGraphicalUiElementByName("Row4Keys") as Algorhytms.GumRuntimes.ContainerRuntime;
                Row5Keys = this.GetGraphicalUiElementByName("Row5Keys") as Algorhytms.GumRuntimes.ContainerRuntime;
                KeyBackspace = this.GetGraphicalUiElementByName("KeyBackspace") as Algorhytms.GumRuntimes.DefaultForms.ButtonRuntime;
                KeyReturn = this.GetGraphicalUiElementByName("KeyReturn") as Algorhytms.GumRuntimes.DefaultForms.ButtonRuntime;
                KeyLeft = this.GetGraphicalUiElementByName("KeyLeft") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyRight = this.GetGraphicalUiElementByName("KeyRight") as Algorhytms.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
