    ...
    {
        public partial class RadioButtonRuntime : Algorhytms.GumRuntimes.ContainerRuntime
        {
            #region State Enums
                    ...
                    if (value != null)
                    {
                        ...
                        switch(mCurrentRadioButtonCategoryState)
                        {
                            case  RadioButtonCategory.EnabledOn:
                                ColoredFrameInstance.CurrentColorCategoryState = Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                            ...
                            case  RadioButtonCategory.DisabledOn:
                                ColoredFrameInstance.CurrentColorCategoryState = Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
                                ColoredFrameInstance.Blue = 255;
                                ColoredFrameInstance.Green = 255;
                                ColoredFrameInstance.Red = 255;
                                SpriteInstance.Visible = true;
                            ...
                            case  RadioButtonCategory.HighlightedOn:
                                ColoredFrameInstance.CurrentColorCategoryState = Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Yellow;
                                ColoredFrameInstance.Blue = 255;
                                ColoredFrameInstance.Green = 255;
                                ColoredFrameInstance.Red = 255;
                                SpriteInstance.Visible = true;
            ...
            public void InterpolateBetween (RadioButtonCategory firstState, RadioButtonCategory secondState, float interpolationValue) 
            {
                ...
                Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory ColoredFrameInstanceCurrentColorCategoryStateFirstValue= Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory ColoredFrameInstanceCurrentColorCategoryStateSecondValue= Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                ...
                switch(firstState)
                {
                    case  RadioButtonCategory.EnabledOn:
                        ...
                        ColoredFrameInstanceCurrentColorCategoryStateFirstValue = Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                    ...
                    case  RadioButtonCategory.DisabledOn:
                        ...
                        ColoredFrameInstanceBlueFirstValue = 255;
                        setColoredFrameInstanceCurrentColorCategoryStateFirstValue = true;
                        ColoredFrameInstanceCurrentColorCategoryStateFirstValue = Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
                        setColoredFrameInstanceGreenFirstValue = true;
                        ColoredFrameInstanceGreenFirstValue = 255;
                        setColoredFrameInstanceRedFirstValue = true;
                        ColoredFrameInstanceRedFirstValue = 255;
                    ...
                    case  RadioButtonCategory.HighlightedOn:
                        ...
                        ColoredFrameInstanceBlueFirstValue = 255;
                        setColoredFrameInstanceCurrentColorCategoryStateFirstValue = true;
                        ColoredFrameInstanceCurrentColorCategoryStateFirstValue = Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Yellow;
                        setColoredFrameInstanceGreenFirstValue = true;
                        ColoredFrameInstanceGreenFirstValue = 255;
                        setColoredFrameInstanceRedFirstValue = true;
                        ColoredFrameInstanceRedFirstValue = 255;
                ...
                switch(secondState)
                {
                    case  RadioButtonCategory.EnabledOn:
                        ...
                        ColoredFrameInstanceCurrentColorCategoryStateSecondValue = Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                    ...
                    case  RadioButtonCategory.DisabledOn:
                        ...
                        ColoredFrameInstanceBlueSecondValue = 255;
                        setColoredFrameInstanceCurrentColorCategoryStateSecondValue = true;
                        ColoredFrameInstanceCurrentColorCategoryStateSecondValue = Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
                        setColoredFrameInstanceGreenSecondValue = true;
                        ColoredFrameInstanceGreenSecondValue = 255;
                        setColoredFrameInstanceRedSecondValue = true;
                        ColoredFrameInstanceRedSecondValue = 255;
                    ...
                    case  RadioButtonCategory.HighlightedOn:
                        ...
                        ColoredFrameInstanceBlueSecondValue = 255;
                        setColoredFrameInstanceCurrentColorCategoryStateSecondValue = true;
                        ColoredFrameInstanceCurrentColorCategoryStateSecondValue = Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Yellow;
                        setColoredFrameInstanceGreenSecondValue = true;
                        ColoredFrameInstanceGreenSecondValue = 255;
                        setColoredFrameInstanceRedSecondValue = true;
                        ColoredFrameInstanceRedSecondValue = 255;
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Algorhytms.GumRuntimes.DefaultForms.RadioButtonRuntime.VariableState fromState,Algorhytms.GumRuntimes.DefaultForms.RadioButtonRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Algorhytms.GumRuntimes.DefaultForms.RadioButtonRuntime.RadioButtonCategory fromState,Algorhytms.GumRuntimes.DefaultForms.RadioButtonRuntime.RadioButtonCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            public Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime ColoredFrameInstance { get; set; }
            ...
            {
                ColoredFrameInstance = this.GetGraphicalUiElementByName("ColoredFrameInstance") as Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime;
