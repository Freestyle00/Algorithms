    ...
    {
        public partial class SliderRuntime : Algorhytms.GumRuntimes.ContainerRuntime
        {
            #region State Enums
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Algorhytms.GumRuntimes.DefaultForms.SliderRuntime.SliderCategory fromState,Algorhytms.GumRuntimes.DefaultForms.SliderRuntime.SliderCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            public Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime LineInstance { get; set; }
            public Algorhytms.GumRuntimes.DefaultForms.ScrollBarThumbRuntime ThumbInstance { get; set; }
            public Algorhytms.GumRuntimes.ContainerRuntime TrackInstance { get; set; }
            ...
            {
                LineInstance = this.GetGraphicalUiElementByName("LineInstance") as Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime;
                ...
                TrackInstance = this.GetGraphicalUiElementByName("TrackInstance") as Algorhytms.GumRuntimes.ContainerRuntime;
