    ...
    {
        public partial class ButtonRuntime : Algorhytms.GumRuntimes.ContainerRuntime
        {
            #region State Enums
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Algorhytms.GumRuntimes.DefaultForms.ButtonRuntime.VariableState fromState,Algorhytms.GumRuntimes.DefaultForms.ButtonRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Algorhytms.GumRuntimes.DefaultForms.ButtonRuntime.ButtonCategory fromState,Algorhytms.GumRuntimes.DefaultForms.ButtonRuntime.ButtonCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            public Algorhytms.GumRuntimes.RectangleRuntime HighlightRectangle { get; set; }
            public string Text
            {
                get
                {
            ...
            private void AssignReferences () 
            {
                ...
                HighlightRectangle = this.GetGraphicalUiElementByName("HighlightRectangle") as Algorhytms.GumRuntimes.RectangleRuntime;
