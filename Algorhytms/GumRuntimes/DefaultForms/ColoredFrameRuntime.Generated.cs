    ...
    {
        public partial class ColoredFrameRuntime : Algorhytms.GumRuntimes.NineSliceRuntime
        {
            #region State Enums
                    ...
                    if (value != null)
                    {
                        ...
                        switch(mCurrentColorCategoryState)
                        {
                            ...
                            case  ColorCategory.Black:
                                ...
                                TextureTop = 241;
                                break;
                            case  ColorCategory.TransparentBlack:
                                Alpha = 196;
                                TextureTop = 241;
                                break;
                        }
            ...
            public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
            {
                ...
                switch(firstState)
                {
                    case  VariableState.Default:
                        ...
                        TextureHeightFirstValue = 46;
                        setTextureLeftFirstValue = true;
                        TextureLeftFirstValue = 1;
                        setTextureTopFirstValue = true;
                        TextureTopFirstValue = 1;
                        setTextureWidthFirstValue = true;
                        TextureWidthFirstValue = 46;
                        if (interpolationValue < 1)
                        {
                            this.Visible = true;
                        }
                        setWidthFirstValue = true;
                        WidthFirstValue = 104f;
                        if (interpolationValue < 1)
                        {
                ...
                switch(secondState)
                {
                    case  VariableState.Default:
                        ...
                        TextureHeightSecondValue = 46;
                        setTextureLeftSecondValue = true;
                        TextureLeftSecondValue = 1;
                        setTextureTopSecondValue = true;
                        TextureTopSecondValue = 1;
                        setTextureWidthSecondValue = true;
                        TextureWidthSecondValue = 46;
                        if (interpolationValue >= 1)
                        {
                            this.Visible = true;
                        }
                        setWidthSecondValue = true;
                        WidthSecondValue = 104f;
                        if (interpolationValue >= 1)
                        {
                            this.WidthUnits = Gum.DataTypes.DimensionUnitType.Absolute;
                        }
            ...
            public void InterpolateBetween (ColorCategory firstState, ColorCategory secondState, float interpolationValue) 
            {
                ...
                switch(firstState)
                {
                    ...
                    case  ColorCategory.Blue:
                        ...
                        AlphaFirstValue = 255;
                        setTextureTopFirstValue = true;
                        TextureTopFirstValue = 49;
                        break;
                    case  ColorCategory.Green:
                        setAlphaFirstValue = true;
                        AlphaFirstValue = 255;
                        setTextureTopFirstValue = true;
                        TextureTopFirstValue = 97;
                        break;
                    case  ColorCategory.Yellow:
                        setAlphaFirstValue = true;
                        AlphaFirstValue = 255;
                        setTextureTopFirstValue = true;
                        TextureTopFirstValue = 145;
                        break;
                    case  ColorCategory.Red:
                        setAlphaFirstValue = true;
                        AlphaFirstValue = 255;
                        setTextureTopFirstValue = true;
                        TextureTopFirstValue = 193;
                        break;
                    case  ColorCategory.Black:
                        setAlphaFirstValue = true;
                        AlphaFirstValue = 255;
                        setTextureTopFirstValue = true;
                        TextureTopFirstValue = 241;
                        break;
                    case  ColorCategory.TransparentBlack:
                        setAlphaFirstValue = true;
                        AlphaFirstValue = 196;
                ...
                switch(secondState)
                {
                    ...
                    case  ColorCategory.Blue:
                        ...
                        AlphaSecondValue = 255;
                        setTextureTopSecondValue = true;
                        TextureTopSecondValue = 49;
                        break;
                    case  ColorCategory.Green:
                        setAlphaSecondValue = true;
                        AlphaSecondValue = 255;
                        setTextureTopSecondValue = true;
                        TextureTopSecondValue = 97;
                        break;
                    case  ColorCategory.Yellow:
                        setAlphaSecondValue = true;
                        AlphaSecondValue = 255;
                        setTextureTopSecondValue = true;
                        TextureTopSecondValue = 145;
                        break;
                    case  ColorCategory.Red:
                        setAlphaSecondValue = true;
                        AlphaSecondValue = 255;
                        setTextureTopSecondValue = true;
                        TextureTopSecondValue = 193;
                        break;
                    case  ColorCategory.Black:
                        setAlphaSecondValue = true;
                        AlphaSecondValue = 255;
                        setTextureTopSecondValue = true;
                        TextureTopSecondValue = 241;
                        break;
                    case  ColorCategory.TransparentBlack:
                        setAlphaSecondValue = true;
                        AlphaSecondValue = 196;
                        setTextureTopSecondValue = true;
                        TextureTopSecondValue = 241;
                        break;
                }
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime.VariableState fromState,Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory fromState,Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            public override void ApplyState (Gum.DataTypes.Variables.StateSave state) 
            {
                ...
                if (matches)
                {
                    ...
                    else if (category.Name == "ColorCategory")
                    {
                        ...
                        if(state.Name == "Blue") this.mCurrentColorCategoryState = ColorCategory.Blue;
                        if(state.Name == "Green") this.mCurrentColorCategoryState = ColorCategory.Green;
                        if(state.Name == "Yellow") this.mCurrentColorCategoryState = ColorCategory.Yellow;
                        if(state.Name == "Red") this.mCurrentColorCategoryState = ColorCategory.Red;
                        if(state.Name == "Black") this.mCurrentColorCategoryState = ColorCategory.Black;
                        if(state.Name == "TransparentBlack") this.mCurrentColorCategoryState = ColorCategory.TransparentBlack;
                    }
                }
                base.ApplyState(state);
            }
            public ColoredFrameRuntime (bool fullInstantiation = true, bool tryCreateFormsObject = true) 
            	: base(false, tryCreateFormsObject)
            {
                ...
                {
                    Gum.DataTypes.ElementSave elementSave = Gum.Managers.ObjectFinder.Self.GumProjectSave.Components.First(item => item.Name == "DefaultForms/ColoredFrame");
