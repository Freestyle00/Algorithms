    ...
    {
        public partial class ListBoxItemRuntime : Algorhytms.GumRuntimes.ContainerRuntime
        {
            #region State Enums
                    ...
                    if (value != null)
                    {
                        ...
                        switch(mCurrentListBoxItemCategoryState)
                        {
                            case  ListBoxItemCategory.Enabled:
                                BackgroundInstance.CurrentColorCategoryState = Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                                RectangleInstance.Visible = false;
                                break;
                            case  ListBoxItemCategory.Highlighted:
                                BackgroundInstance.CurrentColorCategoryState = Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Yellow;
                                BackgroundInstance.X = 0f;
                                BackgroundInstance.XOrigin = RenderingLibrary.Graphics.HorizontalAlignment.Center;
                                BackgroundInstance.XUnits = Gum.Converters.GeneralUnitType.PixelsFromMiddle;
                                BackgroundInstance.Y = 0f;
                            ...
                            case  ListBoxItemCategory.Selected:
                                BackgroundInstance.CurrentColorCategoryState = Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Green;
                                RectangleInstance.Visible = false;
                                break;
            ...
            public void InterpolateBetween (ListBoxItemCategory firstState, ListBoxItemCategory secondState, float interpolationValue) 
            {
                ...
                Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory BackgroundInstanceCurrentColorCategoryStateFirstValue= Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory BackgroundInstanceCurrentColorCategoryStateSecondValue= Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                bool setBackgroundInstanceXFirstValue = false;
                bool setBackgroundInstanceXSecondValue = false;
                float BackgroundInstanceXFirstValue= 0;
                float BackgroundInstanceXSecondValue= 0;
                ...
                switch(firstState)
                {
                    case  ListBoxItemCategory.Enabled:
                        ...
                        BackgroundInstanceCurrentColorCategoryStateFirstValue = Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                        if (interpolationValue < 1)
                        {
                            this.RectangleInstance.Visible = false;
                        }
                    ...
                    case  ListBoxItemCategory.Highlighted:
                        setBackgroundInstanceCurrentColorCategoryStateFirstValue = true;
                        BackgroundInstanceCurrentColorCategoryStateFirstValue = Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Yellow;
                        setBackgroundInstanceXFirstValue = true;
                        BackgroundInstanceXFirstValue = 0f;
                        if (interpolationValue < 1)
                        {
                    ...
                    case  ListBoxItemCategory.Selected:
                        setBackgroundInstanceCurrentColorCategoryStateFirstValue = true;
                        BackgroundInstanceCurrentColorCategoryStateFirstValue = Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Green;
                        if (interpolationValue < 1)
                        {
                            this.RectangleInstance.Visible = false;
                        }
                ...
                switch(secondState)
                {
                    case  ListBoxItemCategory.Enabled:
                        ...
                        BackgroundInstanceCurrentColorCategoryStateSecondValue = Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                        if (interpolationValue >= 1)
                        {
                            this.RectangleInstance.Visible = false;
                        }
                    ...
                    case  ListBoxItemCategory.Highlighted:
                        setBackgroundInstanceCurrentColorCategoryStateSecondValue = true;
                        BackgroundInstanceCurrentColorCategoryStateSecondValue = Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Yellow;
                        setBackgroundInstanceXSecondValue = true;
                        BackgroundInstanceXSecondValue = 0f;
                        if (interpolationValue >= 1)
                        {
                    ...
                    case  ListBoxItemCategory.Selected:
                        setBackgroundInstanceCurrentColorCategoryStateSecondValue = true;
                        BackgroundInstanceCurrentColorCategoryStateSecondValue = Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Green;
                        if (interpolationValue >= 1)
                        {
                            this.RectangleInstance.Visible = false;
                        }
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Algorhytms.GumRuntimes.DefaultForms.ListBoxItemRuntime.VariableState fromState,Algorhytms.GumRuntimes.DefaultForms.ListBoxItemRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Algorhytms.GumRuntimes.DefaultForms.ListBoxItemRuntime.ListBoxItemCategory fromState,Algorhytms.GumRuntimes.DefaultForms.ListBoxItemRuntime.ListBoxItemCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            public Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime BackgroundInstance { get; set; }
            public Algorhytms.GumRuntimes.TextRuntime TextInstance { get; set; }
            public Algorhytms.GumRuntimes.RectangleRuntime RectangleInstance { get; set; }
            ...
            {
                BackgroundInstance = this.GetGraphicalUiElementByName("BackgroundInstance") as Algorhytms.GumRuntimes.DefaultForms.ColoredFrameRuntime;
                TextInstance = this.GetGraphicalUiElementByName("TextInstance") as Algorhytms.GumRuntimes.TextRuntime;
                RectangleInstance = this.GetGraphicalUiElementByName("RectangleInstance") as Algorhytms.GumRuntimes.RectangleRuntime;
