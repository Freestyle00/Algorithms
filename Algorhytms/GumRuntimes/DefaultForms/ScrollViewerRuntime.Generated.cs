    ...
    {
        public partial class ScrollViewerRuntime : Algorhytms.GumRuntimes.ContainerRuntime
        {
            #region State Enums
                    ...
                    if (value != null)
                    {
                        ...
                        switch(mCurrentScrollBarVisibilityState)
                        {
                            case  ScrollBarVisibility.NoScrollBar:
                                ...
                                ClipContainerInstance.Width = -2f;
                                break;
            ...
            public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
            {
                ...
                switch(firstState)
                {
                    case  VariableState.Default:
                        ...
                        ClipContainerInstanceHeightFirstValue = -2f;
                        if (interpolationValue < 1)
                        {
                        ...
                        ClipContainerInstanceWidthFirstValue = -37f;
                        if (interpolationValue < 1)
                        {
                        ...
                        ClipContainerInstanceXFirstValue = 1f;
                        if (interpolationValue < 1)
                        {
                        ...
                        ClipContainerInstanceYFirstValue = -1f;
                        if (interpolationValue < 1)
                        {
                ...
                switch(secondState)
                {
                    case  VariableState.Default:
                        ...
                        ClipContainerInstanceHeightSecondValue = -2f;
                        if (interpolationValue >= 1)
                        {
                            this.ClipContainerInstance.HeightUnits = Gum.DataTypes.DimensionUnitType.RelativeToContainer;
                        }
                        setClipContainerInstanceWidthSecondValue = true;
                        ClipContainerInstanceWidthSecondValue = -37f;
                        if (interpolationValue >= 1)
                        {
                            this.ClipContainerInstance.WidthUnits = Gum.DataTypes.DimensionUnitType.RelativeToContainer;
                        }
                        setClipContainerInstanceXSecondValue = true;
                        ClipContainerInstanceXSecondValue = 1f;
                        if (interpolationValue >= 1)
                        {
                            this.ClipContainerInstance.XOrigin = RenderingLibrary.Graphics.HorizontalAlignment.Left;
                        }
                        ...
                        ClipContainerInstanceYSecondValue = -1f;
                        if (interpolationValue >= 1)
                        {
                            this.ClipContainerInstance.YOrigin = RenderingLibrary.Graphics.VerticalAlignment.Center;
                        }
            ...
            public void InterpolateBetween (ScrollBarVisibility firstState, ScrollBarVisibility secondState, float interpolationValue) 
            {
                ...
                switch(firstState)
                {
                    case  ScrollBarVisibility.NoScrollBar:
                        setClipContainerInstanceWidthFirstValue = true;
                        ClipContainerInstanceWidthFirstValue = -2f;
                        if (interpolationValue < 1)
                        {
                ...
                switch(secondState)
                {
                    case  ScrollBarVisibility.NoScrollBar:
                        setClipContainerInstanceWidthSecondValue = true;
                        ClipContainerInstanceWidthSecondValue = -2f;
                        if (interpolationValue >= 1)
                        {
                            this.VerticalScrollBarInstance.Visible = false;
                        }
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Algorhytms.GumRuntimes.DefaultForms.ScrollViewerRuntime.VariableState fromState,Algorhytms.GumRuntimes.DefaultForms.ScrollViewerRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Algorhytms.GumRuntimes.DefaultForms.ScrollViewerRuntime.ScrollBarVisibility fromState,Algorhytms.GumRuntimes.DefaultForms.ScrollViewerRuntime.ScrollBarVisibility toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
                ...
                switch(state)
                {
                    case  VariableState.Default:
                        ...
                        newState.Variables.Add(new Gum.DataTypes.Variables.VariableSave()
                        {
                            ...
                            Name = "ClipContainerInstance.Height",
                            Type = "float",
                            Value = ClipContainerInstance.Height + -2f
                        }
                        );
                        newState.Variables.Add(new Gum.DataTypes.Variables.VariableSave()
                        {
                        ...
                        newState.Variables.Add(new Gum.DataTypes.Variables.VariableSave()
                        {
                            ...
                            Name = "ClipContainerInstance.Width",
                            Type = "float",
                            Value = ClipContainerInstance.Width + -37f
                        }
                        );
                        newState.Variables.Add(new Gum.DataTypes.Variables.VariableSave()
                        {
                        ...
                        newState.Variables.Add(new Gum.DataTypes.Variables.VariableSave()
                        {
                            ...
                            Name = "ClipContainerInstance.X",
                            Type = "float",
                            Value = ClipContainerInstance.X + 1f
                        }
                        );
                        newState.Variables.Add(new Gum.DataTypes.Variables.VariableSave()
                        {
                        ...
                        newState.Variables.Add(new Gum.DataTypes.Variables.VariableSave()
                        {
                            ...
                            Name = "ClipContainerInstance.Y",
                            Type = "float",
                            Value = ClipContainerInstance.Y + -1f
                        }
                        );
                        newState.Variables.Add(new Gum.DataTypes.Variables.VariableSave()
                        {
                ...
                switch(state)
                {
                    case  ScrollBarVisibility.NoScrollBar:
                        ...
                        newState.Variables.Add(new Gum.DataTypes.Variables.VariableSave()
                        {
                            ...
                            Name = "ClipContainerInstance.Width",
                            Type = "float",
                            Value = ClipContainerInstance.Width + -2f
                        }
                        );
                        break;
                    case  ScrollBarVisibility.VerticalScrollVisible:
            ...
            public Algorhytms.GumRuntimes.DefaultForms.ScrollBarRuntime VerticalScrollBarInstance { get; set; }
            public Algorhytms.GumRuntimes.ContainerRuntime ClipContainerInstance { get; set; }
            public Algorhytms.GumRuntimes.ContainerRuntime InnerPanelInstance { get; set; }
            	...
            	: base(false, tryCreateFormsObject)
            {
                ...
                {
                    Gum.DataTypes.ElementSave elementSave = Gum.Managers.ObjectFinder.Self.GumProjectSave.Components.First(item => item.Name == "DefaultForms/ScrollViewer");
            ...
            private void AssignReferences () 
            {
                ...
                VerticalScrollBarInstance = this.GetGraphicalUiElementByName("VerticalScrollBarInstance") as Algorhytms.GumRuntimes.DefaultForms.ScrollBarRuntime;
                ClipContainerInstance = this.GetGraphicalUiElementByName("ClipContainerInstance") as Algorhytms.GumRuntimes.ContainerRuntime;
                InnerPanelInstance = this.GetGraphicalUiElementByName("InnerPanelInstance") as Algorhytms.GumRuntimes.ContainerRuntime;
