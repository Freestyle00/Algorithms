    ...
    {
        public partial class ToggleButtonRuntime : Algorhytms.GumRuntimes.ContainerRuntime
        {
            #region State Enums
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Algorhytms.GumRuntimes.DefaultForms.ToggleButtonRuntime.VariableState fromState,Algorhytms.GumRuntimes.DefaultForms.ToggleButtonRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public Algorhytms.GumRuntimes.NineSliceRuntime NineSliceInstance1 { get; set; }
            public Algorhytms.GumRuntimes.ColoredRectangleRuntime ColoredRectangleInstance { get; set; }
            public string Text
            {
                get
                {
            ...
            public ToggleButtonRuntime (bool fullInstantiation = true, bool tryCreateFormsObject = true) 
            	: base(false, tryCreateFormsObject)
            {
                ...
                {
                    Gum.DataTypes.ElementSave elementSave = Gum.Managers.ObjectFinder.Self.GumProjectSave.Components.First(item => item.Name == "DefaultForms/ToggleButton");
            ...
            private void AssignReferences () 
            {
                ...
                NineSliceInstance1 = this.GetGraphicalUiElementByName("NineSliceInstance1") as Algorhytms.GumRuntimes.NineSliceRuntime;
                ColoredRectangleInstance = this.GetGraphicalUiElementByName("ColoredRectangleInstance") as Algorhytms.GumRuntimes.ColoredRectangleRuntime;
